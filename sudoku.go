...
func main(){
    ...
    /* this first puzzle is actually rather dificult, to the level
        ...
        it solve this one, but for now I'm just going to do boo-boo baby key shit.
        */
                ...
                for bCol := 0; bCol < 3; bCol++ {
                    ...
                    for i := bRow*3; i < ((bRow*3)+3); i++ {
                        for j := bCol*3; j < ((bCol*3)+3); j++ {
                            ...
                            //bro, 5 for loops is a lot. how does this even run fast?
...
func printPuzzle(puzzle [9][9]int, iHl int, jHl int ){
    for i := 0; i < 9; i++ {
        if i % 3 == 0 {
            fmt.Println(" +-------+-------+-------+")
        }
